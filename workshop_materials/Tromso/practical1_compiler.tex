...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, sharp corners, enhanced, colback={codebgcolor}, breakable]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colback=white, opacityback=0, breakable, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toprule=.15mm, colframe=quarto-callout-note-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black, colback=white, opacityback=0, breakable, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, toptitle=1mm, arc=.35mm, title={Task}, toprule=.15mm, colframe=quarto-callout-warning-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, colback=white, opacityback=0, breakable, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, toptitle=1mm, arc=.35mm, title={Question}, toprule=.15mm, colframe=quarto-callout-tip-color-frame]

Take a look at the code below and select which of the following
statements about the specified Matérn PC priors are true.
